...
export const UserSidebar = () => {
  ...
  return (
    <aside className="w-fit md:w-full shrink-0">
      ...
      <nav className="flex flex-col space-y-6">
        {navItems.map((item) => (
          <button
            ...
            className={`flex justify-between items-center font-bold tracking-wider text-sm text-left transition-colors cursor-pointer w-fit ${
              tab === item.id
