...
const HeartIcon = () => (
  <svg
    className="w-3.5 h-3.5 inline-block text-primary"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
...
const Footer = () => {
  ...
  return (
    <footer className="bg-footer border-t border-heading/10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-heading/50 text-xs leading-relaxed tracking-[0.15em] uppercase max-w-xs">
              © {new Date().getFullYear()} {siteName ?? "Heritage Threads"}.
            ...
            {activeSocials.length > 0 ? (
              ...
              <>
                <Link
                  ...
                  className="text-heading/50 hover:text-primary transition-colors"
                >
                  <InstagramIcon />
                </Link>
                <Link
      ...
      <div className="border-t border-heading/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-center">
          <p className="text-heading/40 text-[11px] tracking-[0.15em] uppercase text-center">
            Made with <HeartIcon/> by{" "}
            <a
              href="https://wa.me/919386183875"
              target="_blank"
              rel="noopener noreferrer"
